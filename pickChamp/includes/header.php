...
<head>
	...
	<title>Pick Champ <?php echo SEASON_YEAR; ?></title>
				...
				<div class="navbar navbar-default" role="navigation">
					<div class="container-fluid">
						<div class="navbar-header">
							...
							<div id="logo" class="navbar-brand"><img src="images/PickChampLogoSquare.png" alt="Pick Champ <?php echo SEASON_YEAR; ?>" class="img-responsive" /></div>
							<div id="site-title" class="navbar-brand">Pick Champ <?php echo SEASON_YEAR; ?></div>
						</div>
						<div class="navbar-collapse collapse">
							<ul class="nav navbar-nav">
								<li<?php echo (($activeTab == 'home') ? ' class="active"' : ''); ?>><a href="./">Home</a></li>
								<?php if ($user->isAdmin == "F") { ?>
								...
								<?php if ($_SESSION['logged'] === 'yes' && $user->isAdmin == "T") { ?>
								<li class="dropdown">
									...
									<ul class="dropdown-menu">
										...
										<li><a href="loginTimes.php">User Login Times</a></li>
										<li><a href="favTeams.php">Favorite Teams</a></li>
									</ul>
								</li>
								<?php } ?>
							</ul>
